""" Created by: Ono' Uviase
    ...
    File Name: installed_der_processing.py
"""
...
@dp.table(name=f"`{IEDR_CATALOG}`.{SCHEMA}.{UTILITY_ID}_installed_der_normalized_table", table_properties={"quality": "normalized"})
def installed_der_data_normalized():
	schema_mapping = get_schema_mapping(utility_id=UTILITY_ID, dataset_key="installed_der")
